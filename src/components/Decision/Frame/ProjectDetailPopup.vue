            ...
            <div class="rate-info">
              ...
              <div class="rate-wrapper" v-show="!dorate">
                ...
                <div class="comment-list">
                  ...
                  >
                    <div class="comment-header">
                      <div class="left">
                        <img
                          class="avatar"
                          src="@/assets/images/detail/avatar.png"
                        />
                      </div>
                      <div class="right">
                  ...
                  <span class="no-data" v-show="!commentList.length">
                    暂无评价
                  </span>
                </div>
              </div>
              <div class="dorate-wrapper" v-show="dorate">
                <div class="rate-box-header">
                  <div class="left">
                    <img
                      v-if="forceEntity.img"
                      class="item-thumb"
                      :src="`${MediaServer}/images/${forceEntity.img_dir}/${forceEntity.img}`"
                    />
                    <img
                      v-else
                      class="item-thumb"
...
.comment-input {
  .el-textarea__inner {
    ...
    border: solid 0.04vh #4a4949;
    border-radius: 0;
    font-family: PingFang;
    font-size: 1.07vh;
    box-sizing: border-box;
    margin: 0.8vh 0;
    padding: 0.31vh 0.8vh;
    color: #fff;
  }
}
</style>
